  ...
  return (
    <div className="lms-stack">
      ...
      {announcements.length > 0 && (
        <section>
          <SectionTitle href={`/lms/courses/${course.id}/announcements`}>Latest announcements</SectionTitle>
  ...
  return (
    <>
      {showGrade && grade.pct != null && (
        <section>
          <SectionTitle href={`/lms/courses/${courseId}/grades`}>Your grade</SectionTitle>
      ...
      <section>
        <SectionTitle href={`/lms/courses/${courseId}/assignments`}>Coming up</SectionTitle>
        {upcoming.length === 0 ? (
          ...
          <div className="lms-list">
            {await Promise.all(upcoming.map(async (a) => {
              ...
              return (
                <HoverLink key={a.id} href={`/lms/courses/${courseId}/assignments/${a.id}`} className="lms-row">
                  <div className="lms-row__icon" aria-hidden>
                    ✎
                  </div>
                  <div className="lms-row__main">
