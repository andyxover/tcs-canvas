  ...
  return (
    <div className="lms-stack" style={{ maxWidth: 680 }}>
      <div className="lms-breadcrumb">
        <Link href={`/lms/courses/${course.id}/assignments`}>Assignments</Link> /{' '}
        <Link href={`/lms/courses/${course.id}/assignments/${a.id}`}>{a.title}</Link> / Edit
      </div>
      ...
      <form action={action} className="lms-card lms-card--pad">
        ...
        <div className="lms-field">
          <label className="lms-flex" style={{ cursor: 'pointer' }}>
            <input type="checkbox" name="draftCoach" defaultChecked={a.draftCoach} />
        ...
        <div className="lms-field">
          <label className="lms-flex" style={{ cursor: 'pointer' }}>
            <input type="checkbox" name="processCapture" defaultChecked={a.processCapture} />
        ...
        <div className="lms-flex" style={{ marginTop: 8 }}>
          ...
          <Link href={`/lms/courses/${course.id}/assignments/${a.id}`} className="lms-btn lms-btn--ghost">
            Cancel
          </Link>
        </div>
      </form>
